...
global_variables() {
    ...
    # Blog title
    global_title="Zeitkonserve"
    # The typical subtitle for each blog
    global_description="Zeitkonserve"
    # The public base URL for this blog
    global_url="https://preisro.github.io/zeitkonserve"

    # Your name
    global_author="preisro"
    # You can use twitter or facebook or anything for global_author_url
    global_author_url="https://preisro.github.io/zeitkonserve" 
    # Your email
    global_email="-"
